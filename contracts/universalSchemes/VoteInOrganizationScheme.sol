...
contract VoteInOrganizationScheme is UniversalScheme, ExecutableInterface, ActionInterface {
    ...
    mapping(address=>mapping(bytes32=>VoteProposal)) public organizationProposals;
    ...
    */
    ...
    returns(bytes32)
    {
        ...
        organizationProposals[_avatar][proposalId] = VoteProposal({
    ...
    */
    function execute(bytes32 _proposalId, address _avatar, int _param) public returns(bool) {
        ...
        VoteProposal memory proposal = organizationProposals[_avatar][_proposalId];
